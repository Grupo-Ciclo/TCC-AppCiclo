                ...
                <View>
                    ...
                    >                   
                        ...
                        >     
                             ...
                             <View style={{width:65}}>
                              <Image style={{width:50, height:50, }} source={{uri:(url + 'pam3etim/BD/imagem.jpg')}} />
                              </View>
                            ...
                            <Text style={{ color: '#000', fontSize:12 }}>{data.totalBaloes} balões - {data.corBaloes}s</Text>
                                </View>
                            </View>
      ...
      >
         ...
         <Text style={styles.Cliente}>{data.nome} - {data.nivel}</Text>
                ...
                <View style={styles.Section}>
                    <MaterialIcons style={styles.Icon} name="people-outline" size={20} color="#c1c1c1" />
                    <Text style={styles.Entrada}>Total de balões: {data.totalBaloes}</Text>
                    <Text style={styles.Entrada}>Cor dos balões: {data.corBaloes}</Text>
                ...
                <View style={styles.Section}>
                    <MaterialIcons style={styles.Icon} name="mail" size={20} color="#c1c1c1" />
