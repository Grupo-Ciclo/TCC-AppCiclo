...
const NovoUsuario= FC= () => {
    ...
    const [totalBaloes, setTotalBaloes] = useState("");
    const [corBaloes, setCorBaloes] = useState("");
    ...
    async function saveData() {            
           ...
           if (nome == "" || email == "" || senha == "" || totalBaloes == "" || corBaloes == "") {
            showMessage({
    ...
    async function loadData() {
        ...
        try {
            ...
            if (id_reg != "0") {
                ...
                setTotalBaloes(res.data.dados.totalBaloes);
                setCorBaloes(res.data.dados.corBaloes);
    ...
    return (
        <View style={{ flex: 1, marginTop: 20 }}>
            ...
            <View>
                <Text style={styles.TitleInputs}>Total de Balões</Text>

                <TextInput
                    placeholder="Total de balões estourados"
                    onChangeText={(text) => setTotalBaloes(text)}
                    value={totalBaloes}
                    style={styles.TextInput}
            ...
            <View>
                <Text style={styles.TitleInputs}>Cor dos Balões</Text>

                <TextInput
                    placeholder="Cor dos seus balões"
                    onChangeText={(text) => setCorBaloes(text)}
                    value={corBaloes}
                    style={styles.TextInput}
